          ...
          <View style={styles.buttons}>
            <Animatable.View animation={this.state.animation} easing="ease-out">
              <ServicesButton
                onPress={() => {
                  this._changeAnimation();
                  this.handlePress("Beard");
                }}
                line1="Beard"
              />
            </Animatable.View>
            {this.props.waitListFlow.staff.barber ? (
              <Animatable.View
