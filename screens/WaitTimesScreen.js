...
class WaitTimesScreen extends React.Component {
  ...
  handleJoinStaffWaitlist(item) {
    ...
    {
      this.props.currentUser.shop === true
        ? this.props.navigation.navigate("WaitListSignUp")
        : this.props.navigation.navigate("WaitTimes3");
    }
  }
    ...
    return (
      ...
      >
        ...
        <View style={{ width: "75%" }}>
          ...
          >
            Joining the waitlist from your phone will add $1 to your final total
          </Text>
        </View>
                    ...
                    >
                      <View style={styles.joinStaffWaitListButton}>
                        <Text style={styles.joinStaffWaitListButtonText}>
                          Join {item.first_name}'s wait list
                        </Text>
                      </View>
                    </TouchableOpacity>
                  ) : null}
                        ...
                        return (
                          <View key={index}>
                            {this.props.currentUser.staff ? (
                              <TouchableOpacity
                                onPress={() => this.handlePress(item2)}
                              >
                                <View style={styles.waitListCard}>
                                  ...
                                  <View
                                    style={styles.waitListCardRemainingTime}
                                  >
                                    <Text
                                      style={{
                                        fontWeight: "bold",
                                  ...
                                  <View style={styles.waitListCardInfo}>
                                    ...
                                    <View style={styles.waitListCardServices}>
                                      <View style={styles.waitListCardService}>
                                        ...
                                        >
                                          {item2.service1_time} min.
                                        </Text>
                                      </View>
                                      {item2.service2_id ? (
                                        <View
                                          style={styles.waitListCardService}
                                        >
                                          <Text
                                            style={{
                                              paddingTop: 5,
...
export default connect(
  mapStateToProps,
  { signInUser, signUpUser, refreshFalse, refreshTrue, addStaffMember }
)(WaitTimesScreen);
